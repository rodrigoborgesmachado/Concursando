...
SELECT CAST (que.NUMEROQUESTAO as int) numeroquestao, prova.NOMEPROVA FROM rodrigo.QUESTOES que 
INNER JOIN rodrigo.PROVA prova ON que.CODIGOPROVA = prova.CODIGO
ORDER BY 1
